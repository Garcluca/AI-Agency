"""
creates the agents hardcoded as the function and manager assistent in line
that's pretty much it. basic structure being
...
class AssistantManager:
    ...
    def get_assistant(self):
        ...
        if not name in [
            ...
            #   weird that it puts it into a dictionairy beforehand
            assistant_dict = {
